		...
		return (
			exec(
				...
				http("000:GET Home")
					...
					.resources(
						http("001:GET core/i18n/messages")
			...
			.exec(http("002:POST index.php/auth/validate")
					...
					.resources(
						http("003:GET core/i18n/messages")
							.get("/web/index.php/core/i18n/messages")
							.headers(headers_1),
	...
	public static ChainBuilder  logout() {
		return (
			exec(http("013:GET index.php/auth/logout")
				...
				.headers(headers_0)
				.resources(
					http("014:GET core/i18n/messages")
						.get("/web/index.php/core/i18n/messages")
						.headers(headers_1)
				)
			)
	...
	ChainBuilder  employee_actions () {
		...
		return (
			exec(http("015:GET index.php/pim/viewPimModule")
				...
				.headers(headers_0)
				.resources(
					http("016:GET core/i18n/messages")
						.get("/web/index.php/core/i18n/messages")
						.headers(headers_1),
				...
				.exec(http("022:GET index.php/pim/addEmployee")
					...
					.headers(headers_0)
					.resources(
						http("023:GET core/i18n/messages")
							.get("/web/index.php/core/i18n/messages")
							.headers(headers_1),
				...
				.pause(thinkTime())
				.exec(
					http("027:GET core/validation/unique")
						.get("/web/index.php/api/v2/core/validation/unique?value=456987&entityName=Employee&attributeName=employeeId")
						.headers(headers_12)
						.resources(
							http("028:POST api/pim/employees")
				...
				.pause(thinkTime())
				.exec(
					http("029:GET viewPersonalDetails/empNumber/2")
						.get("/web/index.php/pim/viewPersonalDetails/empNumber/2")
						.headers(headers_0)
						.resources(
							http("030:GET core/i18n/messages")
								.get("/web/index.php/core/i18n/messages")
								.headers(headers_1),
							http("031:GET viewPhoto/empNumber/1")
								.get("/web/index.php/pim/viewPhoto/empNumber/1")
								.headers(headers_15),
							http("032:GET viewPhoto/empNumber/2")
							...
							http("037:GET api/leave/holidays")
								...
								.headers(headers_12),
							http("038:GET employees/2/personal-details")
								.get("/web/index.php/api/v2/pim/employees/2/personal-details")
								.headers(headers_6),
							http("039:GET employees/2/custom-fields")
				...
				.exec(http("042:PUT employees/2/personal-details")
				...
				.exec(http("043:GET index.php/pim/viewPimModule")
					...
					.headers(headers_0)
					.resources(
						http("044:GET core/i18n/messages")
							.get("/web/index.php/core/i18n/messages")
							.headers(headers_1),
				...
				.exec(
					// SEARCH_EMPLOYEE,
					http("050:GET api/pim/employees")
				...
				.exec(
					http("051:GET api/pim/employees")
				...
				.exec(http("052:GET viewPersonalDetails/empNumber/2")
					.get("/web/index.php/pim/viewPersonalDetails/empNumber/2")
					.headers(headers_0)
					.resources(
						http("053:GET core/i18n/messages")
							.get("/web/index.php/core/i18n/messages")
							.headers(headers_1),
						http("054:GET viewPhoto/empNumber/1")
							.get("/web/index.php/pim/viewPhoto/empNumber/1")
							.headers(headers_15),
						http("055:GET viewPhoto/empNumber/2")
							.get("/web/index.php/pim/viewPhoto/empNumber/2")
							.headers(headers_15),
						http("056:GET employees/2/custom-fields")
							.get("/web/index.php/api/v2/pim/employees/2/custom-fields?screen=personal")
							.headers(headers_6),
						http("057:GET api/leave/workweek")
							.get("/web/index.php/api/v2/leave/workweek?model=indexed")
							.headers(headers_12),
						http("058:GET pim/employees/2")
							.get("/web/index.php/api/v2/pim/employees/2")
							.headers(headers_12),
						http("059:GET employees/2/personal-details")
							.get("/web/index.php/api/v2/pim/employees/2/personal-details")
							.headers(headers_6),
				...
				.exec(
					http("065:GET contactDetails/empNumber/2")
						.get("/web/index.php/pim/contactDetails/empNumber/2")
						.headers(headers_0)
						.resources(
							http("066:GET core/i18n/messages")
								.get("/web/index.php/core/i18n/messages")
								.headers(headers_1),
							http("067:GET viewPhoto/empNumber/1")
								.get("/web/index.php/pim/viewPhoto/empNumber/1")
								.headers(headers_15),
							http("068:GET viewPhoto/empNumber/2")
								.get("/web/index.php/pim/viewPhoto/empNumber/2")
								.headers(headers_15),
							http("069:GET employee/2/contact-details")
								.get("/web/index.php/api/v2/pim/employee/2/contact-details")
								.headers(headers_6),
							http("070:GET employees/2/custom-fields")
								.get("/web/index.php/api/v2/pim/employees/2/custom-fields?screen=contact")
								.headers(headers_6),
							http("071:GET pim/employees/2")
								.get("/web/index.php/api/v2/pim/employees/2")
								.headers(headers_12),
				...
				.exec(http("074:GET contact-details/validation/work-emails")
					...
					.headers(headers_12)
					.resources(
						http("075:PUT employee/2/contact-details")
				...
				.exec(http("076:GET index.php/pim/viewPimModule")
					...
					.headers(headers_0)
					.resources(
						http("077:GET core/i18n/messages")
							.get("/web/index.php/core/i18n/messages")
							.headers(headers_1),
				...
				.pause(thinkTime())
				.exec(
					http("083:DELETE api/pim/employees")
